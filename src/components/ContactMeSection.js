        ...
        <Box p={6} rounded="md" w="100%">
          <form>
            <VStack spacing={4}>
              ...
              sx={{
                "& > option": {
                  backgroundColor: "lightblue", // Cambia el color a tu preferencia
              ...
              <Button type="submit" colorScheme="purple" width="full"  isDisabled={isLoading || !formik.isValid || Object.keys(formik.touched).length === 0}>
